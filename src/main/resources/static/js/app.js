                ...
                function (user) {
                    ...
                    var tr = $('<tr/>')
                        ...
                        .append($('<td/>')
                            ...
                            .append('<button class="btn btn-info editBtn" data-target="#editModal" ' +
                                'data-toggle="modal" type="button">Edit</button>'))

                        .append($('<td/>')

                            .append('<button class="btn btn-danger deleteBtn" data-target="#deleteModal" ' +
                                'data-toggle="modal" type="button">Delete</button>'));
                    tbody.append(tr);
